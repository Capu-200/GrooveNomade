          ...
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form action="#" method="POST" className="space-y-6">
              ...
              <div>
                <button
                  type="submit"
                  className="flex w-full justify-center rounded-md bg-purple-500 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-purple-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple-600"
                >
                  Se connecter
                </button>
              </div>
            ...
            <p className="mt-10 text-center text-sm/6 text-gray-500">
              ...
              <a href="#" className="font-semibold text-purple-500 hover:text-indigo-600">
                Créez-en un !
              </a>
            </p>
          </div>
